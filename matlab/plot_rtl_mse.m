...
% fpath = '../TFLAF_LUT/simulation/outputs/expt2/';
fpath = '../HBOTFLAF_LUT_LessD/simulation/outputs/expt2/';
% fpath = '../LogTFLAF_LUT/simulation/outputs/expt2/';
% fpath = '../LogHBOTFLAF_LUT_LessD/simulation/outputs/expt2/';
