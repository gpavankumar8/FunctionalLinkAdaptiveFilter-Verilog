function [error, log_s_vec, log_s_vec_sign, log_s_vec_zero, log_g_vec, log_g_vec_sign, log_g_vec_zero] = LogHBOTFLAF_filter_fxd_mitch(x, d, w, a, log_s_vec, log_s_vec_sign, log_s_vec_zero, log_g_vec, log_g_vec_sign, log_g_vec_zero, par, fraclen, wrdlen, logsin16, logcos16, antilog_lut, log_lut, lut_fraclen, log_acc_lut, log_fraclen)
% 
%     lut_fraclen = 5;
% 
    log_wrdlen = 17;
...
% log2(cos/sin) LUT
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%     [log_g_val, log_g_val_zero, log_g_val_sign] = log_lut_phi(x, Q, log_fraclen, lut_fraclen, logsin16, logcos16, log_lut);
%     log_sign_zero_det(x, lut_fraclen, par);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    log_w_s_vec_fi = log_w_fi + [0, log_s_vec_fi(1:length(w)-1)];
